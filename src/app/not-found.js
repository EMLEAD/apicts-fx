  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-rose-50 flex items-center justify-center px-6">
      <div className="max-w-2xl w-full text-center">
        {/* 404 Number */}
        <div className="mb-8">
          <h1 className="text-9xl md:text-[200px] font-bold text-black opacity-50">
            404
          </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link href="/">
            <button className="flex items-center gap-2 bg-green-600 text-white px-8 py-3 rounded-md font-semibold hover:bg-blue-700 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 shadow-md">
              <Home size={20} />
              Go to Homepage
            </button>
          </Link>
